...
<template lang="pug">
    .bookMain_age
        ...
        .bookMain_fail_content
            b-scroll(:data="typeList" , ref="scollView")
                img(@load="scollRefresh",src="../../../assets/img/common/fail.png")
...
export default {
    ...
    data() {
        return {
           typeList:[],
           title:"归还失败" ,
           titles:"订阅计划到期后可取消信用免押借还特权",
           description:"如有疑问，请致电0571-86113050",
           buttons: [{
                type: 'warn',
                text: '有效期内无法取消',
            }]
