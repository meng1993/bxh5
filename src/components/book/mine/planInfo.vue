        ...
        .bookMain_listContent
            ...
            ref="scollView"
                ...
                ul.bookMain_cardList
                    router-link(v-show="title!='小博士季卡（无限次）' || title!='小博士季卡（无限次）'" to="/book_rule?type=H5",class="") 订阅计划使用规则与政策
                    router-link(v-show="title=='小博士季卡（无限次）' || title=='小博士季卡（无限次）'" to="/book_rule?type=H52",class="") 订阅计划使用规则与政策
