...
<template>
    <div class="order_container">
        <x-header class="bookorder_header" :left-options="{backText: ''}">我的订单</x-header>
            ...
            <li @click="getInfo(item.order_id)" class="order_single" v-for="item in orderList[this.currentType]">
                ...
                <div class="order_single_content">
                    ...
                    <div class="order_single_text">
                        ...
                        <p v-show="item.relet_price!=0" class="order_single_relet">
...
<script>
  import { Scroller, XImg, Masker, Actionsheet, Spinner, XButton, Group, Cell, LoadMore, Toast, XHeader } from 'vux';
