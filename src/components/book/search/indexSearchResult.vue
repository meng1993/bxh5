...
<template lang="pug">
    ...
    .bookMain_list
        .bookMain_toolbar
            ...
            .bookMain_toolbar_close(@click='goBack') 返回
        ...
        .bookMain_listContent(v-show="!haveData")
            ...
            :swiper_nodata="swiper_nodata"
                ...
                book-list(:commonBookList="bookList",type="0",:refresh.native="scollRefresh" v-if="param.type != 2")
                book-list(:commonBookList="bookList",type="2",:refresh.native="scollRefresh" v-else)
</template>
...
export default {
    ...
    methods: {
        ...
        search: function() {
            ...
            this.param.keywords = this.keyword;
            this.order_method = 0,
            this.chooseId = 0;
            this.showType = false;
            this.listRefresh()
        ...
        getList() {
            ...
            API.book.classifiedSearch(this.param).then((res) => {
    ...
    activated() {
        ...
        this.keyword =  this.param.keywords;
        this.chooseId = this.param.order_method;
        this.listRefresh();
    }
}
</script>
