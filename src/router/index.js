...
/* 个人中心相关 */
import B_mine_plan from '../components/book/mine/plan.vue'; //我的书架计划
import B_mine_myplan from '../components/book/mine/myplan.vue'; //我的计划
import indexSearch from '../components/book/search/indexSearch.vue'; //我的书架计划
...
import B_mine_putcomment from '../components/book/mine/putcomment'
import B_mine_commentlist from '../components/book/mine/commentlist' //评价列表
...
import B_bookOrder from '../components/book/order/bookOrder1.vue';
/* 搜索页面 */
...
import B_indexSearchRe from '../components/book/search/indexSearchResult.vue'; //首页搜素详情页面
/* 成功页面 */
...
//查看物流
import seeLogistics from '../components/book/Logistics.vue';
import serverState from '../components/common/serverState.vue';
//服务说明事项
import serverItem from '../components/common/serverItem.vue';
import jiaokuaidi from '../components/mine/jiaokuaidi.vue'
import guihuanzhong from '../components/mine/guihuanzhong.vue'
import shouyehuodong2 from '../components/book/shouyehuodong2'
//旧书换权益规则
import oldBookRecycling from '../components/common/oldBookRecycling.vue';
...
const routes = [{
    ...
    },
  {
    path: '/jiaokuaidi',
    name: 'jiaokuaidi',
    component: jiaokuaidi
  },
  {
    path: '/guihuanzhong',
    name: 'guihuanzhong',
    component: guihuanzhong
  },
  {
        path: '/logincode',
        name: 'logincode',
    ...
    {
      //旧书换权益规则
      path: '/oldBookRecycling',
      component: oldBookRecycling,
      meta: {
        title: '共享图书规则'
      }
    }
    ...
    },
    {
        ...
        path: '/mine_commentlist',
        name: 'B_mine_commentlist',
        component: B_mine_commentlist
    },{
        path: '/mine_putcomment',
        name: 'B_mine_putcomment',
        component: B_mine_putcomment
    },{
    ...
    /* 选书页面 */
    {
        ...
        name: 'book_indexSearchRe',
        component: B_indexSearchRe
    }, {
